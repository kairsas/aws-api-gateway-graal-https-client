...
RUN /usr/lib/graalvm/bin/native-image --no-server -H:EnableURLProtocols=http,https --enable-all-security-services -H:+JNI -cp build/libs/aws-api-gateway-graal-*-all.jar 
